...
// Constants (Global & Fully Optimized)
const horse = "trojan";
const flash = "vmess";
const neko = "vless";
const v2 = "v2ray";
...
export default {
  async fetch(request, env, ctx) {
    try {
      ...
      newResponse.headers.set("X-Proxied-By", "Cloudflare Worker Premium Safe");
      return newResponse;
    ...
    .pipeTo(
      new WritableStream({
        async write(chunk, controller) {
          ...
          handleTCPOutBound(remoteSocketWrapper, protocolHeader.addressRemote, protocolHeader.portRemote, protocolHeader.rawClientData, webSocket, responseHeader);
        },
        close() {
